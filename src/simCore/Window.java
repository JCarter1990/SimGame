 ...
 * @author JCarter
 */
class Window extends Enterable
{
    Window(String name, boolean openState, boolean lockState, String id)
    {
        this.name = name;
    ...
    boolean getState(TextFlow inputHistory)
    {
        ...
        {
            inputHistory.getChildren().add(
                     new Text("You open the window and climb through." + "\n"));
            this.isOpen = true;
            state = true;
        }
